...
export default function AuthorMeta(props: { author: AuthorInterface, updatedAt: string, createdAt: string, emphasizeAuthor?: boolean, tag?: any }) {
    return <div
        ...
        author={props.author}/> <span className={props.tag ? 'ml-1' : ''}>{props.tag}</span> <span className="mx-1">&#8212;</span> {TimeUtil.toHumanTime(props.createdAt)}</div>
}
