...
export default function AuthModal() {
    ...
    const showModal = () => {
        return <div className="fixed z-10 inset-0 overflow-y-auto" role="dialog" aria-modal="true">
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20">
                ...
                <div className="card bg-white p-10 z-20 w-full" style={{maxWidth: '470px'}}>
                    <div className={'text-right'}>
                        <button type={'button'} className="btn btn-link text-xl" onClick={() => auth.closeAuthModal()}>
    ...
    return (
        auth.isAuthModalOpened ? showModal() : null
    )
}
